                  ...
                  <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          ...
                          <tr>
                            <td class="content-cell">
                              <div class="f-fallback">
                                <h1>Hi,</h1>
                                <p>We are happy to signed up for SPM. To start exploring our App, please confirm your email address<strong>This link is only valid for the next 24 hours.</strong></p>
                                <!-- Action -->
                   ...
                   https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                          <td align="center">
                                            <a href="http://localhost:3000/activate/${userToken}" color="#fff" class="f-fallback button button--green" target="_blank">Verify Email</a>
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
